...
| LATLONG TWODOTS COORDENADA {Printf.printf "%s\n" $3; flush stdout}
| STRINGS TWODOTS REAL {Printf.printf "%f\n" $3; flush stdout}
| ADDITIONAL_INFORMATION TWODOTS {}
...
| SATELLITE_SYSTEM TWODOTS STRINGS STRINGS  {Printf.printf "%s%s\n" $3 $4}
...
| STRINGS STRINGS DOT STRINGS TWODOTS REAL  {Printf.printf "%f\n" $6}
| STRINGS STRINGS TWODOTS REAL  {Printf.printf "%f\n" $4}
| STRINGS STRINGS TWODOTS REAL  {Printf.printf "%f\n" $4}
